...
function About() {
  return (
    ...
    className="W-full py-20 px-[4.5vw] bg-[#CDEA68] rounded-t-3xl text-black">
      <h1 className="text-[3.5vw] leading-[4vw] tracking-tight">
        ...
        <br /> <u>explain complex ideas</u>, and <u>hire great people</u>.
      </h1>

      <div className=" textpart  flex justify-between mt-[3vw]  border-y	 border-[#a1b562]  pt-[1.5vw] pb-[4vw]">
