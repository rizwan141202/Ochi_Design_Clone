          ...
          <div key={index} className="Masker ">
            <div className="w-fit flex items-center overflow-hidden">
              {index === 1 && (
                ...
                ></motion.div>//if we add motion in ahead of div then we can perform animation on that div only without adding motion we cannot perform animation on normal div.
              )}
